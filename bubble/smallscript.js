...
var nodes = [
  {
    name: "me",
    target: [0],
    img: "bubble/bbl/santhosh_bubble.png",
    click: "Resume",
    link: "https://www.linkedin.com/in/santhoshsoundararajan"
  },
  {
    name: "Data Analytics",
    target: [0],
    img: "bubble/bbl/pyd_bbl.png",
    click: "View Posts",
    link: "blog.html"
  },
  {
  ...
  },
  {
    ...
    target: [1],
    target: [0],
    img: "bubble/bbl/pjt_bbl.png",
    click: "View Projects",
    link: "https://github.com/Santhosh114"
  },
  {
    name: "Data Visualizations",
    target: [0, 1, 2, 3],
    img: "bubble/bbl/viz_bbl.png",
    click: "View Posts",
    link: "blog.html"
  }
];
...
node
  ...
  .attr("x", function(d, i) {
    if (i > 0) {
      return circleWidth - 120;
    } else {
      return circleWidth + 70;
    }
  })
  .attr("y", function(d, i) {
    if (i > 0) {
